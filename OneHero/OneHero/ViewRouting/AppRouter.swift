...
final class AppRouter {
    ...
    fileprivate func showMain() {
        ...
        let vc = RoutingDestination.home.getScreen()
...
//            if let sourceController = currentScreenId.getScreen() as? HomeViewController {
//                vc.transitioningDelegate = sourceController
//            }
...
extension AppRouter: StoreSubscriber {
    ...
    func performTransition(to scene: RoutingDestination, transitionType: SceneTransitionType, with animationType: AnimationType = .standard) {
        ...
        case .present, .alert:
           // present(scene: scene, currentScreenId: currentScreenId)
            break
        case .back:
